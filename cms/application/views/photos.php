<style>
	@import "/js/jquery-upload/css/jquery.fileupload.css";
	@import "/js/jquery-upload/css/jquery.fileupload-ui.css";
</style>
...
<script src="/js/jquery-upload/js/vendor/jquery.ui.widget.js"></script>
...
<script src="/js/jquery-upload/js/jquery.fileupload-image.js"></script>
<!-- The File Upload audio preview plugin -->
<script src="/js/jquery-upload/js/jquery.fileupload-audio.js"></script>
<!-- The File Upload video preview plugin -->
<script src="/js/jquery-upload/js/jquery.fileupload-video.js"></script>
...
<script src="/js/jquery-upload/js/cors/jquery.xdr-transport.js"></script>
<![endif]-->   
</div>
